def onboard():
    ...
    print(
        """
================================================================================
  meerkat-beams — Setup Instructions
================================================================================
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Push your project to GitHub:
    ...
    gh repo create landmanbester/meerkat-beams --public --source=. --push

  Or create the repo manually at https://github.com/new and push:

    git remote add origin git@github.com:landmanbester/meerkat-beams.git
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Scroll down to "Add a new pending publisher" and fill in:
    PyPI project name: meerkat-beams
    Owner:             landmanbester
    Repository:        meerkat-beams
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/meerkat-beams/settings/environments
...
────────────────────────────────────────────────────────────────────────────────
  ...
  a) Create the app:
     ...
     Settings:
       Name:        meerkat-beams-bot (or any name you like)
       Homepage:    https://github.com/landmanbester/meerkat-beams
  ...
  d) Add secrets to your repository:
     ...
     Go to: https://github.com/landmanbester/meerkat-beams/settings/secrets/actions
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/meerkat-beams/settings/rules
...
────────────────────────────────────────────────────────────────────────────────
  ...
  The container image is stored in src/meerkat_beams/_container_image.py
  ...
  When you create a feature branch:
    ...
    1. Edit src/meerkat_beams/_container_image.py and change the tag:

         CONTAINER_IMAGE = "ghcr.io/landmanbester/meerkat-beams:my-feature"
